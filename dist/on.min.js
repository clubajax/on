...
return value ? ("object" == typeof value ? Object.keys(value).forEach(function(key) {
INVALID_PROPS[key] || (object[key] = value[key]);
}) : object.value = value, object) : object;
}
try {
"function" == typeof define && define.amd ? require("keyboardevent-key-polyfill") : "undefined" != typeof exports && "undefined" != typeof module ? module.require("keyboardevent-key-polyfill") : window.keyboardeventKeyPolyfill = keyboardeventKeyPolyfill;
} catch (e) {
